...
enum AppConstants {
    static let appName = "Cursor Control"
    static let bundleIdentifier = "io.github.cursorcontrol.CursorControl"
    ...
    static let cursorDragModifier: ShortcutModifiers = .shift
}
